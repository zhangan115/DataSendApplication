package com.example.yanfa.myapplication.blueTooth;
...
import com.example.yanfa.myapplication.utlis.Util;
...
//            notifyUI(Listener.MSG, "发送响应的消息：" + msg);
    ...
    private boolean checkSend() {
        if (isSending) {
            DataApp.toast("正在发送其它数据,请稍后再发...", 0);
            return true;
        }
        return false;
    }
